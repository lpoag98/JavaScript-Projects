...
const Calculator =  {
    ...
    First_Operand: null,
    //This checks wether nor not the second operand has been inputted by the user.
...
function Input_Decimal(dot) {
    //This ensures that accidental clicking of the decimal point dosent 
...
function Update_display() {
    //Makse use of the calculator-screen class to target the 
    //imput tag in the HTML doc
...
keys.addEventListener('click', (event) => {
    //The targetvariable is an object that represents the element
    //that was clicked.
    const { target } = event;
